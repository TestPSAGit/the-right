...
public class HomePageComponentsAC {
    ...
    static String CheckTitleBrandPresent(WebDriver driver) {
        SwitchToCurrentUrl(driver);
        return driver.findElement(By.xpath("//div[@class='wcstore_citreon']")).getText();

    }

    static boolean CheckLogoPresent(WebDriver driver) {
        SwitchToCurrentUrl(driver);
        return driver.findElement(By.xpath("//img[@class='logo-citroen']")).isDisplayed();
    }
    ...
    static String CheckClickOnHeaderCitoënLogo(WebDriver driver) {
        SwitchToCurrentUrl(driver);
        driver.findElement(By.xpath("//img[@class='logo-citroen']")).click();
